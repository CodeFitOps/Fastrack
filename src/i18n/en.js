...
export const en = {
  ...
  'backup.wipe': 'WIPE THIS DEVICE',
  'backup.wipeConfirm': "This deletes the running fast, the history and every log on this device. It can't be undone — export a copy first if it matters. If you sync, they will come back down from the server.",
  'backup.wipeYes': 'WIPE',
